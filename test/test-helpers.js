...
function seedUsers(db, users) {
    ...
    return db.into('plant_dex_users').insert(preppedUsers)
        .then(() =>{
            db.raw(
                `SELECT setval('plant_dex_users_id_seq, ?)`,
...
function cleanTables(db) {
    return db.transaction(trx =>
      ...
      .then(() =>
        Promise.all([
          trx.raw(`ALTER SEQUENCE plant_dex_plant_info_id_seq minvalue 0 START WITH 1`),
          trx.raw(`ALTER SEQUENCE plant_dex_users_id_seq minvalue 0 START WITH 1`),
